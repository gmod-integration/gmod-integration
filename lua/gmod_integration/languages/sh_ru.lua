return {
  ...
  ["admin.server_id_config_move"] = "Все игровые настройки сервера были перенесены в веб-панель.\n{1}",
  ...
  ["admin.update_available"] = "Доступно обновление! Последняя версия: {1}, вы используете: {2}. Если вы используете версию из мастерской, просто перезагрузите ваш сервер",
